...
class AppTest {
    ...
    void testReversedSequence() {
        ReversedSequence reversedSequence = new ReversedSequence("testString");
        assertThat(reversedSequence.length()).isEqualTo(10);
        assertThat(reversedSequence.charAt(0)).isEqualTo('g');
        assertThat(reversedSequence.subSequence(0, 2)).isEqualTo("gn");
    }
    // END
}
